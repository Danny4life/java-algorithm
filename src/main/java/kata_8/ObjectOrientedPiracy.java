...
//        Task
//        You have access to the ship "draft" and "crew". "Draft" is the total ship weight and
...
//        the draft is still more than 20, then the ship is worth looting. Any ship weighing that
...
public class ObjectOrientedPiracy {
    ...
    public void isWorthIt(double draft, int crew){
        double totalDraft = crew * 1.5;
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(titanic.isWorthIt(5,5));
    }
}
