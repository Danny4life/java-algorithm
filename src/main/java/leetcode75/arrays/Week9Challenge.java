...
//
//        Parameters
//        jobs: Integers[] - A non-empty array of positive integers representing
//        the clock cycles needed to finish a job.
//
...
//            assertEquals(40, Challenge.sjf(new ArrayList<Integer>

import java.util.*;

public class Week9Challenge {
    public static void main(String[] args) {
        System.out.println(sjf(new ArrayList<Integer>(Arrays.asList(3, 10, 10, 20, 1, 2)), 2));
    }
