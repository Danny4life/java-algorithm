...
//        (each card is used only once per game). The third player makes his move after the second player,
//        and he sees the previous moves.
//        The goal of the round is to move by the card with the most points. By the way, there are no rules that
//        require players to make only the best moves.
...
//
//        Example
//        Round 1: Frank 2 5 8 11, Sam 1 4 7 10, Tom 0 3 6 9. Tom has to start from 0. Frank is risking nothing
//        and goes 2. Sam gets lucky and wins round by throwing 4.
//
...
public class AnotherCardGame {
    ...
    public static void main(String[] args) {
        System.out.println(Game(new int[]{1,2,3,4}, new int[]{5,6,7,8}, new int[]{0,9,10,11}));
    }
