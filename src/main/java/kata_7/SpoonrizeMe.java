...
//
//        In its most basic form a spoonerism is a two word phrase in which only the first letters
...
//        a spoonerism of those words in a string, as in the above example. A "word" in the context of this kata can
//        contain any of the letters A through Z in upper or lower case, and the numbers 0 to 9.
...
//        a slightly more challenging take on the idea can be found here:
//        http://www.codewars.com/kata/56dbed3a13c2f61ae3000bcd


public class SpoonrizeMe {
    public static void main(String[] args) {
        System.out.println(spoonerize("nit picking")); //pit nicking
    }
